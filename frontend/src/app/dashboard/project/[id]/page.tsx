...
export default function ProjectWorkspace() {
  ...
  const handleStartPreview = async () => {
    ...
    try {
      ...
      setPreviewError(error instanceof Error ? error.message : "Failed to start preview server");
    } finally {
  ...
  const handleStopPreview = async () => {
    ...
    try {
      ...
      setPreviewError(error instanceof Error ? error.message : "Failed to stop preview server");
    }
  };
